...
type Options struct {
	...
	RouteGroupsFile       string   `flag:"route-groups-file" cfg:"route_groups_file"`
...
func NewFlagSet() *pflag.FlagSet {
	...
	flagSet.String("route-groups-file", "", "YAML file for configureing per route authorization")
